      ...
      namespace shader
      {
        namespace standard
        {
          ...
          { return 
            ...
            "varying vec2 var_texcoords[ " + std::to_string( count_of_textures ) + " ];"
            ...
            "varying float var_texblends[ " + std::to_string( count_of_textures ) + " ];\n"
            ...
            "uniform float texblends[ " + std::to_string( count_of_textures ) + " ];\n"
            ...
            "  for ( int n = 0; n < " + std::to_string( count_of_textures ) + "; ++n )\n"
